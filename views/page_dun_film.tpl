...
{block name="contenu"}
    <div class="container pt-5">
        ...
        <a class="btn btn-secondary" href="index.php?controller=movie&action=contact"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-share" viewBox="0 0 16 16">
